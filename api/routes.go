...
func (s *server) routes() {
	...
	api.HandleFunc("/{account}/movers/{group}/{name}/runs", s.StartTaskHandler).Methods(http.MethodPost)
	api.HandleFunc("/{account}/movers/{group}/{name}/runs", s.StopTaskHandler).Methods(http.MethodPut)
